...
POLICY_REQUIRED_SECTIONS = {
    ...
    "права субъекта": [
        ...
        # Типовые шаблоны (Tilda / «Политика…»): раздел 4
        ...
        "требовать от оператора уточнения",
    ...
    "правовые основания": [
        ...
        "законные интересы", "законных интересов",
        "основание для обработки",
        "правовое основание", "правовых оснований",
        "на основании",
        "согласно законодательству",
        # Типовые формулировки ст. 6 152-ФЗ (шаблоны политик)
...
CONSENT_REQUISITES = {
    "оператор":  [
        "оператор", "наименование", "далее — оператор", "далее оператор",
        "далее - оператор", "далее-оператор",
    ],
    "цели":      [
        "цель", "цели обработки", "цель обработки", "в целях",
        "для целей", "целях обработки",
    ],
    "перечень":  [
        "перечень", "категории данных", "состав данных",
        "категории персональных", "категория персональных",
        "состав персональных", "перечень персональных",
    ],
    "срок":      [
        "срок", "сроки", "период действия", "срок обработки",
        "срок хранения", "сроки обработки", "сроки хранения",
    ],
    "отзыв":     [
        "отзыв", "отозвать", "отзыв согласия", "отозвать согласие",
    ],
}

# Ссылки у чекбокса → полный текст согласия/политики (Tilda и др.)
CONSENT_DOC_HREF_HINTS = (
    "soglas", "polit", "privacy", "personal", "confiden",
    "obrabot", "pd-policy", "pd_policy", "personal-data",
    "policy", "consent",
)
CONSENT_DOC_TEXT_HINTS = (
    "политик", "согласи", "персональн", "обработк", "конфиденц",
    "privacy", "consent",
)
